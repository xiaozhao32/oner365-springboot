...
class HttpClientUtilsTest extends BaseUtilsTest {
    ...
    void test() throws IOException {
        ...
        //
        // String url = PublicConstants.FILE_HTTP + hostname +
        // ":15672/api/queues///oner365.saveTaskLogTask";
        // System.out.println(URLEncoder.encode(url,Charset.defaultCharset().name()));
        // ClientHttpConnector httpConnector = new ReactorClientHttpConnector();
        // WebClient webClient =
        // WebClient.builder().clientConnector(httpConnector).baseUrl(URLEncoder.encode(url,Charset.defaultCharset().name())).build();
