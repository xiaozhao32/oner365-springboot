...
class SysMenuDaoTest extends BaseDaoTest {
    ...
    void testInsert() {
        ...
        Map<String, Object> result = insertAutoIncrementId(sql, new Object[] { "test", 999, 1.2d, "abc", 1,
                DateUtil.getCurrentDate(), DateUtil.getCurrentTime(), DateUtil.getCurrentTime() });
