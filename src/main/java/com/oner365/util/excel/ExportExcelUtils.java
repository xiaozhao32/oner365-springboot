...
public class ExportExcelUtils {
    ...
    public static void exportExcel(String fileName, String[] columnName, String[] titleKey, List<?> dataList,
        ...
        try (Workbook workbook = exportExcel(fileName, DataUtils.getFileName(fileName), columnName, titleKey, dataList,
                fileSuffix);
     ...
     * @param fileSuffix 默认扩展名
     */
    public static void exportExcel(String fileName, String[] columnName, String[] titleKey,
            Map<String, List<?>> mapList, String filePath, String fileSuffix) {
    ...
    private static Workbook exportExcel(String fileName, String sheetName, String[] columnName, String[] titleKey,
            List<?> objectList, String fileSuffix) {
        String extension = DataUtils.getExtension(fileName);
                            ...
                            if (type.equals(String.class)) {
                                ...
                                if (!DataUtils.isEmpty(dateString)) {
                                    value = DateUtil.dateToString(
                                            DateUtil.stringToDate(dateString, DateUtil.FULL_TIME_FORMAT),
                                ...
                                String value = StringUtils.EMPTY;
                                if (d != null) {
                                    value = DateUtil.dateToString(DateUtil.localDateTimeToDate(d),
                                            DateUtil.FULL_TIME_FORMAT);
                                }
                                Cell cell = row.createCell(n);
                                cell.setCellValue(value);
