...
public class ExportExcelUtils {
   ...
   * @param fileSuffix 默认扩展名
   */
  public static void exportExcel(String fileName, String[] columnName, String[] titleKey, Map<String, List<?>> mapList,
      String filePath, String fileSuffix) {
            ...
            if (name.equals(pName[j])) {
              ...
              if (type.equals(String.class)) {
                ...
                if (!DataUtils.isEmpty(dateString)) {
                  value = DateUtil.dateToString(DateUtil.stringToDate(dateString, DateUtil.FULL_TIME_FORMAT),
