...
public class MqttReceiverTaskLogServiceImpl implements IMqttReceiverTaskLogService {
    ...
    @Override
    @ServiceActivator(inputChannel = MqttConstants.IN_BOUND_CHANNEL + QueueConstants.SAVE_TASK_LOG_QUEUE_NAME,
    ...
    public void message(Object message) {
        ...
        // business
        SysTaskDto sysTask = GsonUtils.jsonToBean(message.toString(), SysTaskDto.class);
        if (sysTask != null) {
