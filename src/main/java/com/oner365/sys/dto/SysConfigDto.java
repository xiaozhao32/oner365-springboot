 ...
 * @author zhaoyong
 */
@Schema(description = "nt_sys_config")
public class SysConfigDto implements Serializable {
    ...
    /** 配置内容 */
    @Schema(description = "配置内容", requiredMode = RequiredMode.NOT_REQUIRED)
    ...
    /** 更新时间 */
    @Schema(description = "更新时间", requiredMode = RequiredMode.NOT_REQUIRED)
