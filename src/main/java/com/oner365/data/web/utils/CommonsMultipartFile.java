...
public class CommonsMultipartFile implements MultipartFile, Serializable {
    ...
    protected boolean isAvailable() {
        ...
        if (this.fileItem instanceof DiskFileItem item) {
            return item.getStoreLocation().exists();
        }
    ...
    public String getStorageDescription() {
        ...
        else if (this.fileItem instanceof DiskFileItem item) {
            return "at [" + item.getStoreLocation().getAbsolutePath() + "]";
        }
        else {
            return "on disk";
        }
