...
import com.oner365.monitor.util.SpringUtils;
...
public class RedisUtils {
     ...
     * <P>
     * limit-设置扫描的限制数量(默认为0,查询全部) pattern-设置键的匹配模式(默认为null)
     * chunkSize-设置每次扫描的块大小(默认为0,本方法设置为1000) type-设置键的类型(默认为null,查询全部类型)
     * </P>
     * @see KeysScanOptions
     * @param pattern 字符串前缀
     * @return 对象列表
     ...
     * <P>
     * limit-设置扫描的限制数量(默认为0,查询全部) pattern-设置键的匹配模式(默认为null) chunkSize-设置每次扫描的块大小(默认为0)
