...
public class ScheduleTaskConstants extends PublicConstants {
     ...
     * 定时任务队列类型
     */
    public static final String SCHEDULETASK_QUEUE_TYPE= SCHEDULETASK_QUEUE_NAME + "." + PublicConstants.MQ_FANOUT;
     ...
     * 更新执行状态队列类型
     */
    public static final String TASK_UPDATE_STAUTS_QUEUE_TYPE = TASK_UPDATE_STAUTS_QUEUE_NAME + "." + PublicConstants.MQ_FANOUT;
