...
CREATE TABLE "public"."gen_table" (
  "table_id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY (INCREMENT 1 MINVALUE  1 MAXVALUE 100000 START 1 CACHE 1 ),
...
CREATE TABLE "public"."gen_table_column" (
  "column_id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY (INCREMENT 1 MINVALUE  1 MAXVALUE 100000 START 1 CACHE 1 ),
  "table_id" int8,
